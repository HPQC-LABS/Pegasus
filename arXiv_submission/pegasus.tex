...
\subfloat[Tilted classic]{\includegraphics[width=0.33\textwidth]{metapostfigs/fig_ChimeraStdRect5x5_crop}}
\subfloat[Diamond]{\includegraphics[width=0.33\textwidth]{metapostfigs/fig_ChimeraDmdRect5x5_crop}}
\subfloat[Upper triangle]{\includegraphics[width=0.33\textwidth]{metapostfigs/fig_ChimeraTrpRect5x5_crop}}
\end{figure*}
...
\subfloat[Tilted classic\vspace{2mm}]{\centering~~~~~~~~~~~~~~~~\includegraphics[width=0.22\textwidth]{metapostfigs/fig_ChimeraStdRectUC}}~~~~~~~~
\subfloat[Diamond\vspace{2mm}]{\includegraphics[width=0.22\textwidth]{metapostfigs/fig_ChimeraDmdRectUC}}~~~~~~~~
\subfloat[Upper triangle\vspace{2mm}]{\includegraphics[width=0.22\textwidth]{metapostfigs/fig_ChimeraTrpRectUC}}
\end{figure}
\par\end{center}
...
\includegraphics[width=0.24\textwidth]{metapostfigs/fig_ChimeraDmdRect5x5_crop}}~~\subfloat[Upper triangle\vspace{2mm}
]{
...
\includegraphics[width=0.24\textwidth]{metapostfigs/fig_ChimeraDmdRect5x5}}~~\subfloat[Upper triangle\vspace{2mm}
]{
...
\includegraphics[width=0.22\textwidth]{metapostfigs/fig_PegasusDmdRectUC}}~~~~~~~~\subfloat[Upper triangle\vspace{2mm}
]{
