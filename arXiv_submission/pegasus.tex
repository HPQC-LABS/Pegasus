...
and the HAS (János Bolyai Research Scholarship and ``Lendület'' Program).
...
\newgeometry{top=15mm,bottom=0mm,left=8mm,right=8mm} \onecolumngrid
\begin{center}\vspace{-15mm}
\centering
\part*{\centering Supplementary Material}
\vspace{10mm}
...
~~~~~~~~~~~~~~~~\includegraphics[width=0.22\textwidth]{/home/nike/Pegasus/metapostfigs/fig_ChimeraStdRectUC}}~~~~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.22\textwidth]{/home/nike/Pegasus/metapostfigs/fig_ChimeraDmdRectUC}}~~~~~~~~\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.22\textwidth]{/home/nike/Pegasus/metapostfigs/fig_ChimeraTrpRectUC}}
\end{figure}
\par\end{center}
...
\includegraphics[width=0.24\textwidth]{/home/nike/Pegasus/metapostfigs/fig_ChimeraStdRect5x5_crop}}~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.24\textwidth]{/home/nike/Pegasus/metapostfigs/fig_ChimeraDmdRect5x5_crop}}~~\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.24\textwidth]{/home/nike/Pegasus/metapostfigs/fig_ChimeraTrpRect5x5_crop}}~~\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.24\textwidth]{/home/nike/Pegasus/metapostfigs/fig_ChimeraDotRect5x5_crop}}
\end{figure}
\par\end{center}
...
\includegraphics[width=0.24\textwidth]{/home/nike/Pegasus/metapostfigs/fig_ChimeraStdRect5x5}}~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.24\textwidth]{/home/nike/Pegasus/metapostfigs/fig_ChimeraDmdRect5x5}}~~\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.24\textwidth]{/home/nike/Pegasus/metapostfigs/fig_ChimeraTrpRect5x5}}~~\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.24\textwidth]{/home/nike/Pegasus/metapostfigs/fig_ChimeraDotRect5x5}}
\end{figure}
\par\end{center}
...
\begin{center}
\begin{figure}[H]
\caption{Pegasus cells.\centering}

\subfloat[Tilted classic\vspace{2mm}
]{

~~~~~~~~~~~~~~~~~\includegraphics[width=0.22\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdRectUC}}~~~~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.22\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdRectUC}}~~~~~~~~\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.22\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpRectUC}}
\end{figure}
\par\end{center}
...
\begin{figure}[H]
\vspace{-10mm}
\caption{\centering64 inter-layer edges (Pegasus).}
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdRect5x5one_crop}}~~~~~~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdRect5x5one_crop}}~~~~~~~~~~

\vspace{10mm}

\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpRect5x5one_crop}}~~~~~~~~~~\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDotRect5x5one_crop}}
\end{figure}
\par\end{center}
...
\caption{\centering64 inter-layer edges within an $(X,Y,Z)=(5,5,3)$ lattice
(Pegasus).}
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdRect5x5one}}~~~~~~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdRect5x5one}}~~~~~~~~~~

\subfloat[Upper triangle\vspace{20mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpRect5x5one}}~~~~~~~~~~\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDotRect5x5one}}
\end{figure}
\par\end{center}
...
\begin{center}
\begin{figure}[H]
\caption{\centering64 inter-layer edges within a $(X,Y,Z)=(5,5,3)$ \emph{tilted}
lattice (Pegasus).}
\vspace{15mm}
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdTilt5x5one}}~~~~~~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdTilt5x5one}}\vspace{10mm}

\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpTilt5x5one}}~~~~~\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDotTilt5x5one}}
\end{figure}
\vfill{}
\begin{figure}[H]
\vspace{10mm}
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdRect5x5full_crop}}~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdRect5x5full_crop}}~~~~~\vspace{15mm}

\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpRect5x5full_crop}}\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDotRect5x5full_crop}}
\end{figure}
\par\end{center}
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdTilt5x5full_crop}}~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdTilt5x5full_crop}}~~~~~\vspace{10mm}

\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpTilt5x5full_crop}}\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDotTilt5x5full_crop}}
\end{figure}
\par\end{center}
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdRect5x5fullblue_crop}}~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdRect5x5fullblue_crop}}~~~~~~~~~~\vspace{15mm}

\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpRect5x5fullblue_crop}}\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDotRect5x5fullblue_crop}}
\end{figure}
\vfill{}
\par\end{center}
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdTilt5x5fullblue_crop}}~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdTilt5x5fullblue_crop}}~~~~~~~~~~\vspace{10mm}

\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpTilt5x5fullblue_crop}}\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDotTilt5x5fullblue_crop}}
\end{figure}
\vfill{}
\begin{figure}[H]
\vspace{10mm}
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdRect5x5full}}~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdRect5x5full}}~~~~~~~~~~\vspace{10mm}

\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpRect5x5full}}~\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDotRect5x5full}}
\end{figure}
\vfill{}
\par\end{center}
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdTilt5x5full}}~~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdTilt5x5full}}~~~~~~~~~~\vspace{7mm}

\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpTilt5x5full}}~~~\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDotTilt5x5full}}
\end{figure}
\vfill{}
\par\end{center}
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdRect5x5fullblue}}~~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdRect5x5fullblue}}~~~~~~~~~~
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpRect5x5fullblue}}~~~~\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDotRect5x5fullblue}}
\end{figure}
\vfill{}
\par\end{center}
...
\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusStdTilt5x5fullblue}}~~~~~~~\subfloat[Diamond\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDmdTilt5x5fullblue}}~~~~~~~~~~\vspace{10mm}

\subfloat[Upper triangle\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusTrpTilt5x5fullblue}}~~~~~\subfloat[Compressed\vspace{2mm}
]{

\includegraphics[width=0.48\textwidth]{/home/nike/Pegasus/metapostfigs/fig_PegasusDotTilt5x5fullblue}}
\end{figure}
\par\end{center}
